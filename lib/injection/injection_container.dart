...
import 'package:todoapp/data/repositories/background_repositories_impl.dart';
...
void configureDI() {
  getIt
    ...
    ..registerLazySingleton<BackgroundRepository>(() => BackgroundRepositoriesImpl(getIt()))
    ..registerFactory(() => BackgroundCubit(getIt()));
}
